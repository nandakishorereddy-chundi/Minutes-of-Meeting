...
<div id="update">
<div id="popupContact">
<form action="update.php" id="form" method="post" name="form">
<img id="close" src="img/3.png" onclick ="div3_hide()">
<h2>Update Details</h2>
<hr>
<label for="id">
<?php
echo "<input id='id' name='customer_id' value=$id type='text'/>"
?>
</label>
<label for="fname">
<?php
...
<?php
echo "<input id='phoneno' name='phone_no' value= $phone type='text'/>"
?>
<br>
<br>
