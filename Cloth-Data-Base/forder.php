...
<button class='btn btn-info' onclick="div4_show()">Customer</button>
...
<a href="proceed.php" class="btn btn-success" style="position:absolute; margin-left:800px">Make Payment</a>
<h4>FinalPrice:<?php echo $pri ?> </h4>
</p>
