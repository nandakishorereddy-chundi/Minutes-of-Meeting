...
<div id="update">
<div id="popupContact">
<form action="ordupdate.php" id="form" method="post" name="form">
<img id="close" src="img/3.png" onclick ="div3_hide()">
<h2>Update Details</h2>
<hr>
<?php
echo "ProductID : <input id='id' name='pid' value=$id type='text'readonly>"
?>
<?php
echo "UnitPrice : <input id='id' name='unitprice' value=$up type='number' readonly/>"
?>
<br><br>
<?php
	echo "Quantity :<input id='name' name='quantity' value=$qu type='number'/>"
?>
<br>
<br>
